...
using Toko_makan.Models;

namespace Toko_makan.Controllers
{
    public class BarangsController : Controller
    {
        private readonly kasirContext _context;

        public BarangsController(kasirContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdBarang,NamaBarang,Kadaluarsa,JumlahBarang")] Barang barang)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdBarang,NamaBarang,Kadaluarsa,JumlahBarang")] Barang barang)
        {
